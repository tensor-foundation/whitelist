...
This is a quick guide to help you contribute to the JavaScript client of Whitelist.
...
- `VERCEL_PROJECT_ID` — The ID of the Vercel project you want to deploy to.
  The convention is to create a new Vercel project named `whitelist-js-docs` with the following deployment settings:
