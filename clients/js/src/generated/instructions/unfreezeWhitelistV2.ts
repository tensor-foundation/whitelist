...
export const UNFREEZE_WHITELIST_V2_DISCRIMINATOR = new Uint8Array([
  51, 105, 214, 84, 252, 188, 26, 1,
]);

export function getUnfreezeWhitelistV2DiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    UNFREEZE_WHITELIST_V2_DISCRIMINATOR
  );
}
...
export function getUnfreezeWhitelistV2InstructionDataEncoder(): Encoder<UnfreezeWhitelistV2InstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({
      ...value,
      discriminator: UNFREEZE_WHITELIST_V2_DISCRIMINATOR,
    })
  );
}
