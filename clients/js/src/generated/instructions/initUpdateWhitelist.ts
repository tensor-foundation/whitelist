...
export const INIT_UPDATE_WHITELIST_DISCRIMINATOR = new Uint8Array([
  255, 1, 192, 134, 111, 49, 212, 131,
]);

export function getInitUpdateWhitelistDiscriminatorBytes() {
...
export function getInitUpdateWhitelistInstructionDataEncoder(): Encoder<InitUpdateWhitelistInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({
      ...value,
      discriminator: INIT_UPDATE_WHITELIST_DISCRIMINATOR,
    })
  );
}
