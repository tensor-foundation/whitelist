...
export const FREEZE_WHITELIST_V2_DISCRIMINATOR = new Uint8Array([
  69, 158, 243, 78, 116, 68, 221, 113,
]);

export function getFreezeWhitelistV2DiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    FREEZE_WHITELIST_V2_DISCRIMINATOR
  );
}
...
export function getFreezeWhitelistV2InstructionDataEncoder(): Encoder<FreezeWhitelistV2InstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: FREEZE_WHITELIST_V2_DISCRIMINATOR })
  );
}
