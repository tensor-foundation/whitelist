...
export const REALLOC_AUTHORITY_DISCRIMINATOR = new Uint8Array([
  128, 120, 16, 197, 85, 34, 2, 91,
]);

export function getReallocAuthorityDiscriminatorBytes() {
...
export function getReallocAuthorityInstructionDataEncoder(): Encoder<ReallocAuthorityInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: REALLOC_AUTHORITY_DISCRIMINATOR })
  );
}
