...
export const REALLOC_WHITELIST_DISCRIMINATOR = new Uint8Array([
  173, 147, 168, 152, 181, 46, 55, 60,
]);

export function getReallocWhitelistDiscriminatorBytes() {
...
export function getReallocWhitelistInstructionDataEncoder(): Encoder<ReallocWhitelistInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: REALLOC_WHITELIST_DISCRIMINATOR })
  );
}
