...
export const UNFREEZE_WHITELIST_DISCRIMINATOR = new Uint8Array([
  215, 119, 9, 92, 160, 139, 226, 253,
]);

export function getUnfreezeWhitelistDiscriminatorBytes() {
...
export function getUnfreezeWhitelistInstructionDataEncoder(): Encoder<UnfreezeWhitelistInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: UNFREEZE_WHITELIST_DISCRIMINATOR })
  );
}
