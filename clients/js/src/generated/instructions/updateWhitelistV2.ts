...
export const UPDATE_WHITELIST_V2_DISCRIMINATOR = new Uint8Array([
  184, 188, 157, 214, 205, 49, 74, 226,
]);

export function getUpdateWhitelistV2DiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    UPDATE_WHITELIST_V2_DISCRIMINATOR
  );
}
...
export function getUpdateWhitelistV2InstructionDataEncoder(): Encoder<UpdateWhitelistV2InstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: UPDATE_WHITELIST_V2_DISCRIMINATOR })
  );
}
