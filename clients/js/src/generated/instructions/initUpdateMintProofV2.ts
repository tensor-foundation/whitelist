...
export const INIT_UPDATE_MINT_PROOF_V2_DISCRIMINATOR = new Uint8Array([
  35, 185, 181, 108, 143, 139, 228, 45,
]);

export function getInitUpdateMintProofV2DiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    INIT_UPDATE_MINT_PROOF_V2_DISCRIMINATOR
  );
}
...
export function getInitUpdateMintProofV2InstructionDataEncoder(): Encoder<InitUpdateMintProofV2InstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({
      ...value,
      discriminator: INIT_UPDATE_MINT_PROOF_V2_DISCRIMINATOR,
    })
  );
}
