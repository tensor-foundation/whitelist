...
export const CLOSE_MINT_PROOF_V2_DISCRIMINATOR = new Uint8Array([
  237, 78, 8, 208, 47, 148, 145, 170,
]);

export function getCloseMintProofV2DiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    CLOSE_MINT_PROOF_V2_DISCRIMINATOR
  );
}
...
export function getCloseMintProofV2InstructionDataEncoder(): Encoder<CloseMintProofV2InstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: CLOSE_MINT_PROOF_V2_DISCRIMINATOR })
  );
}
