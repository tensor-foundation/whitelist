...
export const FREEZE_WHITELIST_DISCRIMINATOR = new Uint8Array([
  248, 112, 12, 150, 175, 238, 38, 184,
]);

export function getFreezeWhitelistDiscriminatorBytes() {
...
export type FreezeWhitelistInstructionData = {
...
export function getFreezeWhitelistInstructionDataEncoder(): Encoder<FreezeWhitelistInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: FREEZE_WHITELIST_DISCRIMINATOR })
  );
}
