...
impl ReallocAuthority {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = ReallocAuthorityInstructionData::new().try_to_vec().unwrap();
...
impl Default for ReallocAuthorityInstructionData {
    fn default() -> Self {
        Self::new()
    }
}

/// Instruction builder for `ReallocAuthority`.
///
/// ### Accounts:
///
...
pub struct ReallocAuthorityBuilder {
...
/// `realloc_authority` CPI accounts.
pub struct ReallocAuthorityCpiAccounts<'a, 'b> {
    /// there can only be 1 whitelist authority (due to seeds),
    /// and we're checking that 1)the correct cosigner is present on it, and 2)is a signer
...
/// `realloc_authority` CPI instruction.
pub struct ReallocAuthorityCpi<'a, 'b> {
...
impl<'a, 'b> ReallocAuthorityCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: ReallocAuthorityCpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `ReallocAuthority` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` whitelist_authority
...
///   2. `[]` system_program
#[derive(Clone, Debug)]
pub struct ReallocAuthorityCpiBuilder<'a, 'b> {
    instruction: Box<ReallocAuthorityCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> ReallocAuthorityCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(ReallocAuthorityCpiBuilderInstruction {
            __program: program,
    ...
    pub fn invoke_signed(
        ...
        let instruction = ReallocAuthorityCpi {
...
#[derive(Clone, Debug)]
struct ReallocAuthorityCpiBuilderInstruction<'a, 'b> {
